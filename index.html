...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- mediaelement -->
        <script src="js/storytelling/mediaelement_and_player.min.js"></script>
        ...
        <script src="js/storytelling/parallax.js"></script>
        <!--------------------------------------------------------------------------------------------------------------->
    ...
    <body>
        <div id="main" role="main">
            ...
            <section id="seventh" class="story" data-speed="4" data-type="background">
                ...
                <script type='text/javascript' src='markercluster/maps/maps_governorates/monate/map_data.js'></script>              
                <script type='text/javascript' src='markercluster/maps/map_dest.js'></script>
